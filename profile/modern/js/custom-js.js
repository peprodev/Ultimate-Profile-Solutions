...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    setTimeout(function () { $(`pdmain form :input`).trigger("refresh"); }, 200);
    ...
    $(document).on("click tap", "#submit-profile-changes", function (e) {
      ...
      $("body").addClass($ld);
      $(".save-user-details").slideUp("fast", function () { $(".save-user-details").html(""); });
        ...
        success: function (e) {
          if (e.success === true) {
            ...
            if (e.data.e) {
              ...
              if (e.data.refresh == true) { setTimeout(function () { window.location.href = window.location.href; }, 500); }
            }
          }
          else {
    ...
    function show_toast(data = "Sample Toast!", bg="", delay = 4500) {
    	if (!$("pdtoast").length) {$(document.body).append($("<pdtoast>"));}else{$("pdtoast").removeClass("active");}
    	setTimeout(function () {
