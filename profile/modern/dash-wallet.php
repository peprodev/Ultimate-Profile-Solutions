...
# @Last modified time: 2022/05/12 02:32:47
...
<div class="container-fluid">
  <?php
    ...
    #woo_wallet_balance_to_add { width: 250px; margin: 0 1rem; }
    .woo-wallet-add-amount { display: flex; align-items: center; }
        ...
        ?>
          <form method="post" action="">
            <div class="woo-wallet-add-amount">
              ...
              ?>
              <input type="number" step="1" min="<?php echo $min_amount; ?>" max="<?php echo $max_amount; ?>" name="woo_wallet_balance_to_add" id="woo_wallet_balance_to_add" class="text woo-wallet-balance-to-add" required="" />
    ...
    echo do_shortcode("[profile-card-3 title='".__('Your Balance: ', 'woo-wallet') . wp_kses(woo_wallet()->wallet->get_wallet_balance(get_current_user_id()), array()) ."']".$tcona."[/profile-card-3]");
