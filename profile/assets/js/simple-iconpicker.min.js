...
(function($) {
  ...
  QL_Icon_Picker.prototype = {
    ...
    makeClear: function(pickerId, $preview) {
      var base = this,
      $clear = $('<button class="remove-icon btn btn-sm-sqc btn-danger"><i class="material-icons">delete_forever</i></button>');
    ...
    makeDisplay: function($brick) {
      var base = this,
        ...
        $body = $("body"),
        $close = $('<button href="#" class="btn btn-sm-sqc btn-danger icon-picker-close"><i class="material-icons">close</i></button>');
    ...
    makeLaunchers: function($brick) {
      ...
      for (iconSet in dataIconSets) {
        if (dataIconSets.hasOwnProperty(iconSet)) {
          $brick.append('<button class="launch-icons btn btn-action btn-sm ' + base.settings.classes.launcher + '" data-icons="' + iconSet + '">' + dataIconSets[iconSet] + "</button>");
        }
      }
    ...
    showPicker: function($brick, $icons, mode) {
      if ("inline" == mode) {
        ...
        if ("dialog" == mode) {
          ...
          $("body").trigger("iconpickershow.dialog.opened");
        }
      }
    ...
    closePicker: function($brick, $icons, mode) {
      ...
      if ("inline" == mode) {
        $brick.find($icons).removeClass("inline-open");
          ...
          $("body").trigger("iconpickershow.dialog.closed");
      }
    ...
    setPreview: function(preview) {
      ...
      $preview.addClass("icon-preview-on").find(">i").removeClass().addClass(this.iconSetName).addClass(preview).removeClass("fa");
      $preview.find("button>i").removeClass().addClass("material-icons");
      $preview.find("button").show();
    }
  };
