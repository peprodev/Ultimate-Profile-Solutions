            ...
            <div class="card-body">
                <form class="edit-profile-form" method="post">
                    <div class="row">
                      <div class="col-12">
                        <?php
                          ...
                          <img src='$saved' width='64' style='margin: 1rem;border-radius: 4px;' id='avatar_b'/><input style='display: inline-block;width: 30%;' id='$id' name='$id' type='$type' class='form-control $class' $extrahtml value='".esc_attr($val)."' /></div>";
                        ?>
                      </div>
                    </div>
                    <div class="row">
                   ...
                   <?php
                    ...
                    <div>
                        <a id="submit-profile-changes" href="#" class="btn btn-lg btn-info btn-block loadingRings">
