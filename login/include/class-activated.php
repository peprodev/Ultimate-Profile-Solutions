        ...
        <div class="nav-tabs-wrapper">
          <ul class="nav nav-tabs">
            <li class="nav-item tab_login">
              <a class="nav-link active show" href="#tab_login" ><i class="material-icons">login</i> <?php echo esc_html_x("Login", "login-section", "peprodev-ups");?></a>
            </li>
            <li class="nav-item tab_registration">
              <a class="nav-link" href="#tab_registration" ><i class="material-icons">app_registration</i> <?php echo esc_html_x("Registration","login-section", "peprodev-ups");?></a>
            </li>
